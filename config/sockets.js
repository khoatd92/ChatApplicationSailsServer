...
module.exports.sockets = {
  ...
  ***************************************************************************/
  ...
  afterDisconnect: function (session, socket, cb) {
    ...
    console.log("afterDisconnect " + socket.id);
    userController.removeUserOffline(socket.id);
    console.log("Current user online size " + userController.getSizeOfUsersOnline());
    return cb();
  },
